...
class CustomTextFieldDrown extends StatefulWidget {
  ...
  @override
  State<CustomTextFieldDrown> createState() => _CustomTextFieldDrownState();
}

class _CustomTextFieldDrownState extends State<CustomTextFieldDrown> {
  @override
  void initState() {
    super.initState();
  }
  ...
  @override
  Widget build(BuildContext context) => DropDownTextField(
